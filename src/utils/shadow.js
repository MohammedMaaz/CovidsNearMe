...
export const getShadow = depth => {
  const apparentDepth = depth - 1 < 0 ? 0 : depth - 1;
  const s = parseShadow(androidDepth.penumbra[apparentDepth]);
  ...
  return {
    ...
    shadowOpacity: Number(
      interpolate(apparentDepth, 1, 24, 0.2, 0.6).toFixed(2),
    ),
